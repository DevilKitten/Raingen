...
def generate_sprite(
    ...
    try:
        ...
        # draw non-boba eyes
        if cat.pelt.eye_colour not in Pelt.riveye_colours and Pelt.buttoneye_colours:
        ...
        # draw riv boba eyes
        if cat.pelt.eye_colour in Pelt.riveye_colours not in Pelt.buttoneye_colours:
            eyes = sprites.sprites["eyes" + cat.pelt.eye_colour + cat_sprite].copy()
            if cat.pelt.eye_colour2 != None:
                eyes.blit(
                    sprites.sprites["eyes2" + cat.pelt.eye_colour2 + cat_sprite], (0, 0)
